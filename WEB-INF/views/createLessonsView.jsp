...
<form method="POST" action="${pageContext.request.contextPath}/createLessons">

        <table class="table table-hover">
        <tr>
            <td>№</td>
            <td><input type="text" name="num" value="${lessons.num}" /></td>
        </tr>
        <tr>
            <td>П-11</td>
