...
@WebServlet(urlPatterns = { "/createLessons" })
public class CreateLessonsServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public CreateLessonsServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getServletContext()
                .getRequestDispatcher("/WEB-INF/views/createLessonsView.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!lessons.equals(lessons))
        {
            ...
            if (errorString == null) {
                try {
                    DBUtils.insertLessons(conn, lessons);
